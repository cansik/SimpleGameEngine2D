...
import ch.nexpose.deepspace.gui.*;
...
public class DialogStory implements IGameStory
{
    ...
    public void runStory()
    {
        ...
        {
            //Dialog Style YES NO
            _menu.addItem(new ch.nexpose.deepspace.gui.MenuItem(_engine, "Yes", _nextStoryYes));
            _menu.addItem(new ch.nexpose.deepspace.gui.MenuItem(_engine, "No", _nextStoryNo));
        }
        else
        {
            //Dialog Style Messagebox
            _menu.addItem(new ch.nexpose.deepspace.gui.MenuItem(_engine, "OK", _nextStoryYes));
        }
